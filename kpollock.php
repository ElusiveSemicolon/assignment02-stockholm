    ...
    <section class="hero is-primary">
      ...
      <div class="hero-body">
        <div class="container has-text-centered">
          ...
          <figure>
            <img class="profile-pic" src="images/kyle.jpg" alt="Kyle">
          </figure>
        </div>
      </div>
      ...
      <div class="hero-foot">
        <nav class="tabs">
          <div class="container">
            <ul>
              <li class="is-active"><a href="kpollock.php">About</a></li>
              <li><a href="kpollock_information_architect.php">Role</a></li>
            </ul>
          </div>
        </nav>
      </div>
    ...
    <section class="hero">
      <div class="hero-body">
        <div class="container">
          ...
          <p>
            I’m a total nerd. And, like most nerds, I played a lot of video games as a kid. I eventually got bored of playing the same games, so I started to modify the code behind my games: adding to them, perfecting them. I didn't know it then, but that was just the start of my love of programming. I moved on from just coding video games to learning multiple programming languages and coding more and more, both in the classroom and beyond.
            Most recently, I have been applying my knowledge of object oriented programming and MVC design pattern  to create mobile applications, both natively with Android Studio and Xcode, as well as hybridized with Angular and the Ionic framework. It is so exciting to see everything I have learned come together in the form of functioning applications!
            I love talking about anything new and exciting in research or technology. Please feel free to send me a message here on LinkedIn or my University of Rochester email: kpolloc3@u.rochester.edu
            Specialties: Web and mobile application development, market research, statistics, and financial accounting and investment.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="hero">
      <div class="hero-body">
        <div class="container">
          ...
          <h3>Market Research and Business Development Intern at CommunityRoot</h3>
          <em>June 2017 - August 2017 (3 months)</em>

          <h3>Software Development Intern at VoicePort, LLC</h3>
          <em>May 2017 - August 2017 (4 months)</em>

          <h3>Cancer Stem Cell Researcher at Cleveland Clinic</h3>
          <em>October 2013 - May 2014 (8 months) </em>
          <ul>
            <li>Assisted with advanced research regarding cancer stem cells</li>
            <li>Learned basic lab procedures and tests such as RT-PCR, western blotting, and flow cytometry</li>
          </ul>
        </div>
      </div>
    </section>
